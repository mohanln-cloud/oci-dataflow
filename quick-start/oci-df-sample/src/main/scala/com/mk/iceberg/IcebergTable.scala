...
/*
  ...
  def runIcebergSample(inputPath: String, outputPath: String) = {
    ...
    USING iceberg
    location 'oci://mk-test-dev18@paasdevssstest/iceberg/db/iceberg_table'""")
    ...
    val t1 = spark.read
      ...
      .load("oci://mk-test-dev18@paasdevssstest/iceberg/db/iceberg_table")
    ...
    val table1 = tables.load("oci://mk-test-dev18@paasdevssstest/iceberg/db/iceberg_table")
